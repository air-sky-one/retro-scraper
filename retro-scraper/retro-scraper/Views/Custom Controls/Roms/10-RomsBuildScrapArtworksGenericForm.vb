Public Class _10_RomsBuildScrapArtworksGenericForm
    ...
    ''' Constructor
    ''' </summary>
    Public Sub New(parent As RomsContainerControl)
    ...
    ''' <param name="e"></param>
    Private Sub _10_RomsBuildScrapArtworksGenericForm_Load(sender As Object, e As EventArgs) Handles Me.Load
        Me.CheckboxFlowLayoutPanel.Visible = False
        Me.MainDataGridView.Visible = False

        Me.MediaTypesComboBox.DataSource = Me._parent.MediaTypes
    ...
    Private Sub MediaTypesComboBox_SelectedIndexChanged(sender As Object, e As EventArgs) Handles MediaTypesComboBox.SelectedIndexChanged
        'SetCheckboxColumnsVisibility(New List(Of DataGridViewCheckBoxColumn) From {})
