    ...
    Private Function Download(ByVal worker As BackgroundWorker, ByVal e As DoWorkEventArgs) As Boolean
        ...
        Try
            ...
            For Each c As RomsDataSet.RomlistRow In Me._parent.RomList
                romlistFileContent.AppendLine(c.Name & ";")
                romlistFileContent.AppendLine(c.Title & ";")
                romlistFileContent.AppendLine(c.Emulator & ";")
                romlistFileContent.AppendLine(c.CloneOf & ";")
                romlistFileContent.AppendLine(c.Year & ";")
                romlistFileContent.AppendLine(c.Manufacturer & ";")
                romlistFileContent.AppendLine(c.Category & ";")
                romlistFileContent.AppendLine(c.Players & ";")
                romlistFileContent.AppendLine(c.Rotation & ";")
                romlistFileContent.AppendLine(c.Control & ";")
                romlistFileContent.AppendLine(c.Status & ";")
                romlistFileContent.AppendLine(c.DisplayCount & ";")
                romlistFileContent.AppendLine(c.DisplayType & ";")
                romlistFileContent.AppendLine(c.AltRomname & ";")
                romlistFileContent.AppendLine(c.AltTitle & ";")
                romlistFileContent.AppendLine(c.Extra & ";")
                romlistFileContent.AppendLine(c.Buttons & ";")
                romlistFileContent.AppendLine()
            Next

            If Me._parent.IsRomListNewFile Then
                If File.Exists(Me._parent.RomsPath & "\romlist.txt") Then File.Delete(Me._parent.RomsPath & "\romlist.txt")
                File.Create(Me._parent.RomsPath & "\romlist.txt")
